...
import time
import requests
import spylunking.tcp_send_to_splunk as send_to_splunk
...
class TCPSplunkPublisher(SocketHandler, object):
    ...
    Here is the additional lines added to it for validation:
...
# end of format_record
    ...
    def __init__(
        ...
        super(TCPLogstashHandler, self).__init__(self.host, self.port)
